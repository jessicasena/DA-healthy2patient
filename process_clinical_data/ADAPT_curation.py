...
def curation():
    logger.add("out.log", backtrace=True, diagnose=True, enqueue=True)
...
if __name__ == "__main__":
    curation()
   # curate_acc("/data2/datasets/ICU_Data/1013_Sensor_Data/I037A/I037A_Accel/2022-05-02_12.30.24_I037A_ankle3,4_SD_Session1/I037A_ankle3,4_Session1_I037A_ankle3,4_Calibrated_SD.csv")
